      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <div className="overflow-hidden rounded-lg bg-white shadow-sm">
          ...
          <div className="space-y-3 p-4 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <span className="flex items-center gap-1"><PhoneOutlined className="text-green-600" /> 1231411111</span>
            </div>
        ...
        <div className="overflow-hidden rounded-lg bg-white shadow-sm">
          ...
          <div className="space-y-2.5 p-4">
            {outcomes.map((item, idx) => (
              <label key={item} className="flex cursor-pointer items-center gap-2 text-sm">
                <input type="radio" name="outcome" defaultChecked={idx === 0} className="accent-[#F28B18]" />
                <span className={idx === 0 ? 'font-medium text-[#F28B18]' : 'text-slate-700'}>{item}</span>
              </label>
            ))}
          ...
          <div className="p-4 pt-0">
            <CrmButton variant="green" className="w-full py-2.5">Submit Response</CrmButton>
          </div>
        </div>
      </div>
    </div>
